...
void InnerProdGPUonly(const double * __restrict__ u,  
	...
	HYPRE_Int hypre_CSRMatrixMatvecOutOfPlaceMult ( HYPRE_Complex alpha , hypre_CSRMatrix *A , hypre_Vector *x , HYPRE_Int k1, HYPRE_Complex beta , hypre_Vector *b, HYPRE_Int k3, hypre_Vector *y, HYPRE_Int k2, HYPRE_Int offset );
