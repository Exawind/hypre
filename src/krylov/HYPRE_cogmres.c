...
HYPRE_Int
HYPRE_COGMRESSetStopCrit( HYPRE_Solver solver,
                              HYPRE_Int          stop_crit )
{
   return( hypre_COGMRESSetStopCrit( (void *) solver, stop_crit ) );
}

HYPRE_Int
HYPRE_COGMRESGetStopCrit( HYPRE_Solver solver,
                              HYPRE_Int        * stop_crit )
{
   return( hypre_COGMRESGetStopCrit( (void *) solver, stop_crit ) );
}
